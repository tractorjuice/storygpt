...
if tabs == "Auto-Generation":
    ...
    if st.button("Next Step"):
        short_memory, st.session_state.long_memory, written_paras, instruction1, instruction2, instruction3 = step(short_memory, st.session_state.long_memory, instruction1, instruction2, instruction3, written_paras)
    ...
    if st.button("Init Novel Generation"):
        short_memory, st.session_state.long_memory, written_paras, instruction1, instruction2, instruction3 = init(novel_type, description)
    ...
    if st.button("Next Step"):
        short_memory, st.session_state.long_memory, written_paras, instruction1, instruction2, instruction3 = controled_step(short_memory, st.session_state.long_memory, selected_instruction, written_paras)
